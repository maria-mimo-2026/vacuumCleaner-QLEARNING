...
def run_tests(env, policy, label, n=N_RUNS):
    ...
    for _ in range(n):
        ...
        if success and getattr(policy, 'policy_id', None) == 'q-learning_2':
        # R_DONE removed: world.py all_clean already included
         results.append({
...
def compare_one_map(map_id):
    ...
    for policy_id, label in [
        ...
        # oqlearning لا يحتاج load_qtable — فقط QL2 يحتاجها
